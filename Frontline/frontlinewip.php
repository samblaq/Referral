<?php
    ...
    $sql = "SELECT * FROM WIP where SalesOfficer = '$PWID'";
                                                    ...
                                                    while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)){
                                                        ...
                                                        echo"
                                                            <tr>
                                                                ...
                                                                <td>".$row['AdminWhoAssigned']."</td>
                                                                <td>".$row['SalesOfficer']."</td>
                                                                <td>
                                                                    <form action='process.php?id=".$row['id']."' method='POST'>
                                                                        <a href='process.php?id=".$row['id']."' style='display: " . ($Status == 1 ? 'none' : 'block') . "'>
                                                                            <input type='submit' value='Process' name='Process' class='btn btn-success btn-xs'>
                                                                        </a>
                                                                    </form>
                                                                </td>
                                                            </tr>";
