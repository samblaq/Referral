                        ...
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    <h3>
                                        <?php
                                            $sql_ReferralDetails = "SELECT COUNT(*) as Count FROM WIP WHERE SalesOfficer = '$PWID'";
                                ...
                                <a href="frontlinewip.php" class="small-box-footer">
                                    View WIP <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h3>
                                        <?php
                                            $sql_ReferralDetails = "SELECT COUNT(*) AS Count FROM ReferralStatus WHERE Status = 'Success' and SalesOfficer = '$PWID'";
                                            $result = sqlsrv_query($conn,$sql_ReferralDetails);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                                                echo $count = $row['Count'];
                                            }
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-red">
                                <div class="inner">
                                    <h3>
                                        <?php
                                            $sql_ReferralDetails = "SELECT COUNT(*) AS Count FROM ReferralStatus WHERE Status = 'Failed' and SalesOfficer = '$PWID'";
                                            $result = sqlsrv_query($conn,$sql_ReferralDetails);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                                                echo $count = $row['Count'];
                                            }
